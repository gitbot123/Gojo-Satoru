...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
 ...
 「 رابط موقع مملكة ستارك 」◣
		    「http://5f72d3dc2a434.site123.me」◣
		    「 انوس عمكم يحبكم ❮•••❯ 🥰 」◣                 
 「 رابط دخول لنقابة روز 」◣
		    「https://chat.whatsapp.com/JN99UBfRBtp4Wg4VmFn8eV」◣
		    「 الي محتاج شي يروح عند المطور 」◣`,
    ...
    case 'donasi': case 'donate': case 'sewabot': case 'sewa': {
            ...
            case 'التسجhgjيل': case 'التسجيل': {
                reply(` 「 رابط نقابة روز 」◣
「 _https://chat.whatsapp.com/JN99UBfRBtp4Wg4VmFn8eV_ 」◣
